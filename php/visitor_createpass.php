...
<link rel="stylesheet" href="../css/createpass_1.css">
 ...
 <form action="visitor_new.php" method="post" name="form1">
 	
<div class="back_ground">     
<h1>Create Pass</h1>         
	<div class="left">
		<input type="text" name="name" onkeypress="return onlyAlphabets(event);"  placeholder="Name" value="<?php echo $fetch[1] ?>"  style="width: 70%; height:30px; border-radius: 10px;border:none; margin-left: 22px; padding: 5px;margin-top: 10px;"><br><br>             
		<label style="margin-left:22px;">Gender : </label><br><br>             
		<div style="margin-top: -8px;margin-left: 46px;">           
		<input <?php if($fetch[2]=="male"){echo "checked";} ?> type="radio" name="gender" value="male" style="margin-left: 18px;"><label>Male</label>             
		<input <?php if($fetch[4]=="female"){echo "checked";} ?> type="radio" name="gender" value="female"><label>Female</label><br></div>
