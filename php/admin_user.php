	...
	<div class="admin_transparent">
		<div class="admin_main">
			...
			<div class="admin_center">
				...
				<input type="text" onkeypress="return onlyAlphabets(event);" name="name" placeholder="Enter your Name" required style="width: 70%; height:1px; border-radius: 10px;border:none; margin-left: 22px; padding: 16px;margin-top: 10px; background-color: antiquewhite;"><br><br>
				<div style="width: 80%;">   
