...
?>
   ...
   <?php include('../visitor_sidebar.php');
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            <div class="content-wrap">
                ...
                <!-- center page-->
                <?php include('visitor_createpass.php');?>                         
        </div>
    </div>
                ...
                <div id="footer">
                    ...
                    <div class="copyright">Footer credits
                        <span class="entypo-heart"></span>2020 <a href="#">Thesmile</a> All Rights Reserved</div>
