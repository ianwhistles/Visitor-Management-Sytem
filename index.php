        ...
        <div class="container-fluid paper-wrap bevel tlbr">
            <div class="content-wrap">
                ...
                <form action="php/pass.php" method="post">
                        <div class="main">
                        <h2>Phone Number</h2>
                        <input type="text" name="phone" style="width: 300px; height: 12px; border-radius: 10px; border: none; padding: 10px;"><br><br>
                ...
                <div id="footer">
                    ...
                    <!-- <div class="copyright">Make with Passion
                        <span class="entypo-heart"></span>2014 <a href="#">Thesmile</a> All Rights Reserved</div> -->
